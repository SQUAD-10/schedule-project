...
const Santos = require('../models/Santos');
...
router.put('/:id', (req, res) => {
  ...
  Santos.findByIdAndUpdate(id, req.body)
    .then(data => {
      !data ?
